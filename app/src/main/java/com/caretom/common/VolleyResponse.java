...
public class VolleyResponse {
    ...
    public interface VolleyResponseListener {
        ...
        void onVolleyResponseGet(String response, int apiCall) throws JSONException;
    }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            mListener.onVolleyResponseGet(response, apiCall);
...
//                Toast.makeText(context, "Volley Error: " + error.getMessage(), Toast.LENGTH_LONG).show();
    ...
    //
    public String getVolleyResponse(String URL, final int apiCall, String progressDialogtext) {
